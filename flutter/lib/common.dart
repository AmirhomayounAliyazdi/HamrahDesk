...
class MyTheme {
  ...
  static const Color button = Color(0xFF001F3F);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        primary: Color(0xFF001F3F), secondary: accent, background: grayBg),
...
Color? _msgboxColor(String type) {
  ...
  return Color(0xFF001F3F); // تغییر داده شده به سرمه‌ای
}
