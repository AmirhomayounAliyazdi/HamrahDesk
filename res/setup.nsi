...
!define PRODUCT_NAME "HamrahDesk"
...
Name "${PRODUCT_NAME}"
Outfile "hamrahdesk-${VERSION}-setup.exe"
...
Section "Install"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "Publisher" "Hamrah Hesabe Amin Ltd."
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "HelpLink" "https://www.hamrahhesabeamin.com/"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "URLInfoAbout" "https://www.hamrahhesabeamin.com/"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "URLUpdateInfo" "https://www.hamrahhesabeamin.com/"
